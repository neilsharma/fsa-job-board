...
The engineering decisions you make will determine whether millions of Americans can access college. You'll help rebuild the system that distributes $120 billion in federal aid each year — the gateway to higher education for an entire generation. After last year's FAFSA rollout left millions of families unable to access aid, we now have both the mandate and the funding to fix critical infrastructure.

## The Technical Challenge

You'll architect and ship the systems behind studentaid.gov, handling:

- Over 10 million applications in a 6-month window with brutal traffic spikes
...
**Role Level:** This is a GS-15 technical position -- the highest rung on the standard government pay scale and equivalent to a Principal or Staff Engineer at a top-tier technology company.
